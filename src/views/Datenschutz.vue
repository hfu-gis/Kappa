        ...
        <v-container>
            <v-row           :align="alignment"
                ...
                <v-col cols="12"
                       md="8"
                       class="text-center">
                    <p class="display-2">Datenschutz</p>
                </v-col>
                <v-col cols="12"
                       md="8"
                       class="text-center">
                    <p>
                        ...
                        Unter den unten angegebenen Kontaktdaten können Sie jederzeit folgende Rechte ausüben:<br>
                        ...
                        Sie können sich jederzeit mit einer Beschwerde an die für Sie zuständige Aufsichtsbehörde wenden. Ihre zuständige Aufsichtsbehörde richtet sich nach dem Ort Ihres Wohnsitzes, Ihrer Arbeit oder der mutmaßlichen Verletzung.<br>
                        Zwecke der Datenverarbeitung durch MySub und Dritte<br>
                        ...
                        Diese Informationen sind technisch notwendig, um von Ihnen angeforderte Inhalte von Webseiten korrekt auszuliefern und fallen bei Nutzung des Internets zwingend an.<br>
                        Anonyme Informationen dieser Art werden von uns statistisch ausgewertet, um unseren Internetauftritt und die dahinterstehende Technik zu optimieren.<br>
                        Erfassung personenbezogener Informationen bei der Nutzung von MySub
                        Soweit auf unseren Seiten personenbezogene Daten (wie Name oder E-Mail-Adresse) erhoben werden, erfolgt dies, soweit möglich, auf freiwilliger Basis. Wir erheben, verarbeiten und nutzen personenbezogene Daten soweit dies erforderlich ist, um Ihnen die Inanspruchnahme des Webangebots zu ermöglichen. Sämtliche personenbezogenen Daten werden nur solange gespeichert wie dies für den genannten Zweck (Dauer einer Umfrage oder eines Messageboards bzw. die Bearbeitung Ihrer Anfrage) erforderlich ist.<br>
                        ...
                        Auf Grundlage Ihrer Einwilligung, übersenden wir Ihnen Benachrichtigungen über neue Kommentare oder Abstimmungen in einer Umfrage per E-Mail an Ihre angegebene E-Mail-Adresse.<br>
                        Für eine wirksame Registrierung benötigen wir eine valide E-Mail-Adresse. Um zu überprüfen, dass eine Anmeldung tatsächlich durch den Inhaber einer E-Mail-Adresse erfolgt, setzen wir das „Double-opt-in“-Verfahren ein. Hierzu protokollieren wir die Bestellung der Benachrichtigungen, den Versand einer Bestätigungsmail und den Eingang der hiermit angeforderten Antwort. Weitere Daten werden nicht erhoben. Die Daten werden ausschließlich für den Benachrichtigungversand verwendet.<br>
